...
|---|---|---|
| 1 | **ACCENT BOARD v2** | Four columns in the identical specimen: ULTRAMARINE `#2C2BE8` marked `SELECTED / CURRENT` *(superseded — the accent is Registration Red)*, SIGNAL CHARTREUSE `#6B8400`, INDUSTRIAL AMBER `#C25E0A`, DIGITAL MAGENTA `#C2007A`. Specimen gains two rows over the existing one: **matte-glass microplate edge** and **one distorted word**. Old board is kept as `SYS / ACCENT — HISTORY` (Registration Red, Cold Cyan). |
